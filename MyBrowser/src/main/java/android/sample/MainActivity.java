            ...
            public void onPageStarted(final WebView view, final String url, final Bitmap favicon) {
                ...
                if(xlarge)
                {
                    ...
                    if(url.startsWith("http://www.nikkei.com/") || url.startsWith("http://k-tai.impress.co.jp/")
                            ...
                            || url.startsWith("http://www.yahoo.co.jp/"))     //nikkeiは150%表示
                    {
                        webView.setInitialScale(150);  //タブレットは150%で表示
                    }
                    else  //nikkei以外は100%表示
                    {
                        webView.setInitialScale(100);  //タブレットは100%で表示
                    }
                }
            }
    ...
    public boolean onMenuItemSelected(int featureId,MenuItem item){
        switch (item.getItemId()) {
            ...
            case NIFTY_NEWS_MENU_ID :
                ...
                return true;
            case KETAI_MENU_ID:
                webView.loadUrl("http://k-tai.impress.co.jp/");
                return true;
            case CLOUD_MENU_ID:
